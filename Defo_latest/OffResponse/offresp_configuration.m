function [v, subs, dirs, time, events,ft_read_sens_string] = offresp_configuration(analysis_type)
    dirs = struct();
    ...
    % [-1.6, 5]
    v.LastOmiR = defineExpStruct("BlockLastAOR", "LastOR", "BlockLastAOR", false, [0, 0, 0]);
    v.LastOmiF = defineExpStruct("BlockLastAOF", "LastOF", "BlockLastAOF", false, [0, 0, 0]);
    ...
    events.adaptor.("event_text") = "last block sound";
