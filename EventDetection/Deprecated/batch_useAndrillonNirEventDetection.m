...
function batch_useAndrillonNirEventDetection(input_dir,output_dir)
    ...
    for mat_file_ind=1:size(matFiles_input,2)
        ...
        minMax_SD_threshold = [4 9 1]; % ,DetectionThreshold, RejectThreshold, StartEndThreshold,
        paramDetection = struct('minMax_SD_threshold',minMax_SD_threshold);
