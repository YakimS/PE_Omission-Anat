...
o_sepRF <- read.csv("C:\\Users\\User\\Cloud-Drive\\BigFiles\\OmissionExpOutput\\mix_modeling\\mm_10_sub-ses-50msTimeWin_traits_posnegClust.csv")
...
o_sepRF$timeWin <- as.ordered(o_sepRF$timeWin)
...
filename = paste("mm_", curr_ver,"_res_sepRF_allFixed+1sub_within-X_interOnly.csv", sep = "")
