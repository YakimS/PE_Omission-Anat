...
timewin = {"0-48","48-100","100-148","148-200","200-248","248-300","300-348","348-400","400-444"};
...
columns = {'sub','ses','timeWin','block_type','seniority','blockpos','opos','ampAvg_pos','ampAvg_neg'};
...
output_filename = sprintf('%s//mm_10_sub-ses-50msTimeWin_traits_posnegClust.csv',output_dir);
mm_i = 1;
got_files = false;
