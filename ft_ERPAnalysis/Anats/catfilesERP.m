function   catfilesERP(pathtofiles_temp, FileId_temp, Variable, OutputName_temp, dims_temp, supersubject)
...
if supersubject == 1 
    ...
    for i_temp = 1 : length(F_temp) 
        ...
        for j_temp=1:length(Variables)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            if i_temp==1                                                                                                    %%%     %%%
                eval(['Cum_',Variables{j_temp},'= nanmean(',Variables{j_temp},',4);']) % for supersubject change 3 to 4 (concatenate on nonexsit dimention)                                                     %%%     %%%
...
elseif supersubject == 0
    ...
    for i_temp = 1 : length(F_temp) 
        ...
        for j_temp=1:length(Variables)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Define cumulating variables on the first run   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     %%%
            if i_temp==1                                                                                                    %%%     %%%
                eval(['Cum_',Variables{j_temp},'= nanmean(',Variables{j_temp},',3);']) % for supersubkect change 3 to 4 (concatenate on nonexsit dimention)                                                     %%%     %%%
            else % this is for the following runs  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     %%%
               eval(['Cum_',Variables{j_temp},'= cat(',num2str(dims_temp(j_temp)),', Cum_',Variables{j_temp},',nanmean(',Variables{j_temp},',3));']) % for supersubkect change 4 to 5 (concatenate on nonexsit dimention)     %%%     %%%
            end %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     %%%
        end             %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
