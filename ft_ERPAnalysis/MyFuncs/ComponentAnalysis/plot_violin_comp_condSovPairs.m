function metadata_comp_string = plot_violin_comp_condSovPairs(f,dirs,out_dir, condSovPairs, elctrds_clusts, component ,plot_name,cfg)
    ...
    for ctp_i=1:numel(fields_elctrds_clusts)
        ...
        [~, comps_struct, metadata] = create_component_amplitude_table(subs, conds_sovs,{component} , conds, elctrds_clusts.(fields_elctrds_clusts{ctp_i}), dirs, f.time);
        ...
        plot_violins(condSovPairsStrings,subs_AvgActivity,curr_output_filename, curr_colormap,f.subs,cfg)
    end
end
