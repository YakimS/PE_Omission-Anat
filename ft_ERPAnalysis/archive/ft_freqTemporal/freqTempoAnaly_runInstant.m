...
args.bl = 100;
args.contrasts = {{'OF','OR'}};%{{'OFFirst5','ORFirst5'},{'OEf6','ORf6'},{'OF','OR'},{'OEf6','OR'}};
args.pre_vs_post_conds_names = {'OF'};%{'OEf5','OEf6','OR','ORf6','OFFirst5','ORFirst5','T','O'};

%% local variables
args.ft_cond_dir= sprintf('C:\\Users\\User\\Cloud-Drive\\BigFiles\\OmissionExpOutput\\ft_erpAnalysis\\data_in_ft_cond_fomat');
args.output_main_dir = sprintf('C:\\Users\\User\\Cloud-Drive\\BigFiles\\OmissionExpOutput\\ft_erpAnalysis\\freqtemp_clusterPerm');
...
save(sprintf("clust_freqTempoAnaly_run_all.mat"),"args",'-mat')
args.wake_files_name_suffix = 'wake_morning_referenced'; %wake_morning_referenced, wake_night_referenced, wake_all_referenced
save(sprintf("clust_freqTempoAnaly_run_morning.mat"),"args",'-mat')
args.wake_files_name_suffix = 'wake_night_referenced'; %wake_morning_referenced, wake_night_referenced, wake_all_referenced
save(sprintf("clust_freqTempoAnaly_run_night.mat"),"args",'-mat')